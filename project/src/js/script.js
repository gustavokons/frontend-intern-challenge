$(document).ready(function () {
	$.getJSON("data/urls.json", function(data) {
		...
		for(var i = 0; i < data.length; i++) {
			if(i < 5) {
				$(".ranking").append("<div class='row'><div class='col-sm-8'><p class='ranking-link'>"+data[i].shortUrl+"</p></div><div class='col-sm-4'><p class='ranking-clicks'>"+data[i].hits+"</p></div></div>");
			}
